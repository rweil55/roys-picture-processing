...
function resizeImage( $img_in, $curWidth, $curHeight,
    ...
    if ( $curHeight > $maxHeight || $curWidth > $maxWidth ) {
        ...
        if($debugResize) $msg .= "imagecopyresampled($img_out, $img_in, 0, 0, 0, 0, $w_dst, $h_new1, $curWidth, $curHeight) $eol";
        imagecopyresampled( $img_out, $img_in, 0, 0, 0, 0, $w_dst, $h_new1, $curWidth, $curHeight )
