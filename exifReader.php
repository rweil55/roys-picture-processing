...
class phpExifReader
{
    ...
    var $thumbnailSize = 0; /* Size of thumbnail */
    var $thumbnailURL = ""; /* */
    var $thumbnailOffset = 0;
    var $DirWithThumbnailPtrs = NULL;
    ...
    function processFile()
    {
        ...
        if (ord($a) != 0xff || ord(fgetc($fp)) != M_SOI) {
            ...
            $this->errstr = "File '" . $this->file . "' is not a JPEG File!";
        }
        ...
        for ($de = 0; $de < $NumDirEntries; $de++) {
            ...
            switch ($Tag) {
                ...
                case TAG_FNUMBER:
                    ...
                    $this->ImageInfo['h']["fnumber"] = sprintf("f/%3.1f", (float)$tmp[0]);
                ...
                case TAG_FOCALLENGTH:
                    ...
                    $this->ImageInfo['h']["focalLength"] = sprintf("%4.2f (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);
                ...
                case TAG_SUBJECT_DISTANCE:
                    ...
                    $this->ImageInfo['h']["Distance"] = sprintf("%4.2f (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);
                    ...
                    if ($this->ImageInfo['h']["Distance"] < 0) {
                        ...
                        $this->ImageInfo['h']["focusDistance"] = sprintf("%4.2fm", (float)$this->ImageInfo['h']["Distance"]);
                    }
                ...
                case TAG_EXPOSURETIME:
                    ...
                    $this->ImageInfo['h']["exposureTime"] = sprintf("%6.3f s (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);
                ...
                case TAG_EXPOSURE_BIAS:
                    ...
                    $this->ImageInfo['h']["exposureBias"] = sprintf("%4.2f (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);
                ...
                case TAG_X_RESOLUTION:
                    ...
                    $this->ImageInfo['h']["xResolution"] = sprintf("%4.2f (%d/%d) %s", (float)$tmp[0], $tmp[1][0], $tmp[1][1], $this->ImageInfo['h']["resolutionUnit"]);
                ...
                case TAG_Y_RESOLUTION:
                    ...
                    $this->ImageInfo['h']["yResolution"] = sprintf("%4.2f (%d/%d) %s", (float)$tmp[0], $tmp[1][0], $tmp[1][1], $this->ImageInfo['h']["resolutionUnit"]);
                ...
                case TAG_GPS_GPSDestDistance: /* Distance to destination                GPSDestDistance     26     */
                    ...
                    $this->ImageInfo['h']["GPSDestDistance"] = sprintf("%4.2f (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);;
                ...
                case TAG_GPS_GPSProcessingMethod: /* Name of GPS processing method          GPSProcessingMethod 27     */
                    ...
                    $this->ImageInfo['h']["GPSProcessingMethod"] = sprintf("%4.2f (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);;
                ...
                case TAG_EXPOSURE_INDEX:
                    ...
                    $this->ImageInfo['h']["ExposureIndex"] = sprintf("%4.2f (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);;
                ...
                case TAG_DIGITAL_ZOOM_RATIO:
                    ...
                    $this->ImageInfo['h']["zoomRatio"] = sprintf("%4.2f (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);
                ...
                case TAG_FOCALPLANE_YRESOL:
                    ...
                    $this->ImageInfo['h']["focalPlaneYResolution"] = sprintf("%4.2f (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);
                ...
                case TAG_BRIGHTNESS:
                    ...
                    $this->ImageInfo['h']["brightness"] = sprintf("%4.2f (%d/%d)", (float)$tmp[0], $tmp[1][0], $tmp[1][1]);
