...
class freeWheeling_DisplayOne
{
    function DisplayOne($attr)
    {
        ...
        global $photoUrl, $photoPath, $photoUrlPath, $thumbUrl, $site_url;
        ...
        try {
            $photoname = rrwUtil::fetchparameterString("photobane", $attr);
        ...
        <td valign='bottom'><img src='$fullfilename2' 
            ...
            ";
            $msg .= rrwUtil::print_r($recset, true, " the record set");
            $msg .= "
    ...
    <ul class='rrwKeywordGrid' role='list'>
        ";
            ...
            if (false !== $meta) {
                $msg .= "<pre>";
                $msg .= print_r($meta, true);
                $msg .= "</pre>";
            }
        } catch (Exception $ex) {
            $msg .= "E#205 DisplayOne  mian routeine";
        }
        return $msg;
    } // end function 
